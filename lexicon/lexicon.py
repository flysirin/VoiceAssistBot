LEXICON: dict[str, str] = {
    ...
    'no_words': [
        r"`This wordless audio file` can show us that emptiness does not mean the absence of manifestation.",
        r"`This wordless audio file` reminds us that emptiness is not an empty place, but rather a state of mind free from attachment and limitation.",
        r"`In this wordless audio file`, we can hear that in the void there is nothing to attach to, but it makes everything possible.",
        r"`This wordless audio file` helps us understand that emptiness is a state in which there are no boundaries and limitations, and everything is possible."],

    'server_error': [
        r"`A server error` is not a failure, but an opportunity to improve."],
}
